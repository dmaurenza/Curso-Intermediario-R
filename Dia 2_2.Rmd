...
Nesta aula vamos aprender a utilizar a ferramenta "Project", que auxilia a organização dos arquivos utilizados no R durante o desenvolvimento de um projeto. Também iremos aprender o conceito mais importante para o usuário de R, a Indexação. Veremos como indexar elementos de um vetor e de um dataframe, e como a fazer substituição de valores usando indexação através da função "ifelse"
