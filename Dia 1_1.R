...
#Nesta aula faremos uma revisão sobre conceito e operacionalização de comandos essenciais para o bom uso do R. Inicialmente, veremos que o R funciona como uma calculadora. Depois, vamos rever as classes dos objetos que podem ser criados no R, tais como vetores, matrizes, dataframes e listas
...
# 1. Qual a raiz quadrada 9 + soma de 3 com 5? Dica: Utilize parenteses para facilitar a interpretação.
