...
1. [Indexando Vetores](#anchor1)
2. [Indexando Dataframes](#anchor2)

## Indexando Vetores {#anchor1}

Indexação é a ação de extrair um elemento específico, ou um conjunto de elementos, de um objeto. Podemos extrair sub-conjuntos específicos de dados de acordo com as ‘coordenadas’ dos dados que queremos, assim como em um jogo de batalha naval.
...
<center><img src="img/Batalha.png" height="250px"></img></center>  
...
```
Neste caso, a indexação está usando um vetor de um ou mais elementos, que marcam as posição dos elementos a serem retidos.Assim, poderíamos criar um vetor com números representando posições específicas que queremos reter
```{r}
numero <- c(1, 5, 7, 9)
vetor1[numero]
vetor1[-numero]
...
1. Utilizando o vetor1, faça uma indexação que retorne:
