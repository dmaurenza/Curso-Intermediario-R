---
title: "Indexação simples de vetores e dataframes"
...
Nesta aula veremos um dos conceitos mais importante para o usuário de R, a Indexação. Estuderemos seus objetivos e os comandos de indexações, seja em vatores ou dataframes


# Elementos da Aula

1. [Indexação de Vetores](#anchor1)
2. [Indexação de Dataframes](#anchor2)

## Indexação de Vetores {#anchor1}
...
### Indexação de Dataframes {#anchor2}
